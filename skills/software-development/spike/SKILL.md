...
- `references/python-cli-project-pattern.md` — Reusable pattern for CLI apps with JSON persistence + unittest + Git + Obsidian tracking (from real sessions building todo.py, cal.py).
